...
class AdpterMovie(private val similarMoviesResponse: List<Result>) : RecyclerView.Adapter<AdpterMovie.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(result: Result) {
            ...
            itemView.movieDescription.text = result.genre_name
        }
    }
